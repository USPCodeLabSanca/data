    ...
    <div className='bg-primary text-center text-white' id='sobre'>
      <div className='container mx-auto px-4'>
        ...
        <p className='text-xl md:text-2xl pb-12 ff-secondary'>
          ...
          auctor mattis mattis. Ut rhoncus diam ac arcu tempus dapibus. Morbi id
          aliquet libero. Fusce posuere posuere dapibus. Duis ligula dolor,
          condimentum quis consectetur ut, fermentum id tellus. Nullam aliquet
          sodales augue. Etiam porta tristique mauris. Donec eu vulputate diam.
        </p>
      </div>
    </div>
  </React.Fragment>
